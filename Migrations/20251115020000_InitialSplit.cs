...
{
    public partial class InitialSplit : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            // -----------------------------------------------------------------
            // Drop child tables if they already exist (from previous attempts)
            // -----------------------------------------------------------------
            migrationBuilder.Sql("DROP TABLE IF EXISTS public.analyzed CASCADE;");
            migrationBuilder.Sql("DROP TABLE IF EXISTS public.dataset_info CASCADE;");
            migrationBuilder.Sql("DROP TABLE IF EXISTS public.image_acquisition CASCADE;");
            migrationBuilder.Sql("DROP TABLE IF EXISTS public.image_correlation CASCADE;");
            migrationBuilder.Sql("DROP TABLE IF EXISTS public.image_data CASCADE;");
            migrationBuilder.Sql("DROP TABLE IF EXISTS public.in_vivo CASCADE;");
            migrationBuilder.Sql("DROP TABLE IF EXISTS public.ontology CASCADE;");
            migrationBuilder.Sql("DROP TABLE IF EXISTS public.procedures CASCADE;");
            migrationBuilder.Sql("DROP TABLE IF EXISTS public.publication CASCADE;");
            migrationBuilder.Sql("DROP TABLE IF EXISTS public.study_component CASCADE;");
            migrationBuilder.Sql("DROP TABLE IF EXISTS public.study_design CASCADE;");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_analyzed", x => x.DatasetId);
                    table.ForeignKey(
                        name: "FK_analyzed_dataset_DatasetId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RorCodeOwner = table.Column<string>(type: "text", nullable: true),
                    Pi = table.Column<string>(type: "text", nullable: true),
                    PiOrchid = table.Column<string>(type: "text", nullable: true),
                    ...
                    FunderId = table.Column<string>(type: "text", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_dataset_info", x => x.DatasetId);
                    table.ForeignKey(
                        name: "FK_dataset_info_dataset_DatasetId",
                        column: x => x.DatasetId,
                        principalSchema: "public",
                        principalTable: "dataset",
                        principalColumn: "dataset_id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_image_acquisition", x => x.DatasetId);
                    table.ForeignKey(
                        name: "FK_image_acquisition_dataset_DatasetId",
                        column: x => x.DatasetId,
                        principalSchema: "public",
                        principalTable: "dataset",
                        principalColumn: "dataset_id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_image_correlation", x => x.DatasetId);
                    table.ForeignKey(
                        name: "FK_image_correlation_dataset_DatasetId",
                        column: x => x.DatasetId,
                        principalSchema: "public",
                        principalTable: "dataset",
                        principalColumn: "dataset_id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ImageAttenuationCorrection = table.Column<string>(type: "text", nullable: true),
                    ...
                    RegistrationAlgorithms = table.Column<string>(type: "text", nullable: true),
                    AiEnhanced = table.Column<string>(type: "text", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_image_data", x => x.DatasetId);
                    table.ForeignKey(
                        name: "FK_image_data_dataset_DatasetId",
                        column: x => x.DatasetId,
                        principalSchema: "public",
                        principalTable: "dataset",
                        principalColumn: "dataset_id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AnimalCondition = table.Column<string>(type: "text", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_in_vivo", x => x.DatasetId);
                    table.ForeignKey(
                        name: "FK_in_vivo_dataset_DatasetId",
                        column: x => x.DatasetId,
                        principalSchema: "public",
                        principalTable: "dataset",
                        principalColumn: "dataset_id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ontology", x => x.DatasetId);
                    table.ForeignKey(
                        name: "FK_ontology_dataset_DatasetId",
                        column: x => x.DatasetId,
                        principalSchema: "public",
                        principalTable: "dataset",
                        principalColumn: "dataset_id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SiteOrRouteOfAdministration = table.Column<string>(type: "text", nullable: true),
                    ...
                    DrugOrBatchSampleNumber = table.Column<string>(type: "text", nullable: true),
                    ...
                    BloodCollectionTiming = table.Column<string>(type: "text", nullable: true),
                    ...
                    TissueDescription = table.Column<string>(type: "text", nullable: true),
                    TissuePerfused = table.Column<string>(type: "text", nullable: true),
                    PerfusionMethod = table.Column<string>(type: "text", nullable: true),
                    ...
                    SpecimenThickness = table.Column<string>(type: "text", nullable: true),
                    ...
                    CellCultureMedium = table.Column<string>(type: "text", nullable: true),
                    ...
                    VirusLabelledOrModified = table.Column<string>(type: "text", nullable: true),
                    ...
                    CellInjectionProcedure = table.Column<string>(type: "text", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_procedures", x => x.DatasetId);
                    table.ForeignKey(
                        name: "FK_procedures_dataset_DatasetId",
                        column: x => x.DatasetId,
                        principalSchema: "public",
                        principalTable: "dataset",
                        principalColumn: "dataset_id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_publication", x => x.DatasetId);
                    table.ForeignKey(
                        name: "FK_publication_dataset_DatasetId",
                        column: x => x.DatasetId,
                        principalSchema: "public",
                        principalTable: "dataset",
                        principalColumn: "dataset_id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_study_component", x => x.DatasetId);
                    table.ForeignKey(
                        name: "FK_study_component_dataset_DatasetId",
                        column: x => x.DatasetId,
                        principalSchema: "public",
                        principalTable: "dataset",
                        principalColumn: "dataset_id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_study_design", x => x.DatasetId);
                    table.ForeignKey(
                        name: "FK_study_design_dataset_DatasetId",
                        column: x => x.DatasetId,
                        principalSchema: "public",
                        principalTable: "dataset",
                        principalColumn: "dataset_id",
        ...
        {
            migrationBuilder.DropTable(name: "analyzed", schema: "public");
            migrationBuilder.DropTable(name: "dataset_info", schema: "public");
            migrationBuilder.DropTable(name: "image_acquisition", schema: "public");
            migrationBuilder.DropTable(name: "image_correlation", schema: "public");
            migrationBuilder.DropTable(name: "image_data", schema: "public");
            migrationBuilder.DropTable(name: "in_vivo", schema: "public");
            migrationBuilder.DropTable(name: "ontology", schema: "public");
            migrationBuilder.DropTable(name: "procedures", schema: "public");
            migrationBuilder.DropTable(name: "publication", schema: "public");
            migrationBuilder.DropTable(name: "study_component", schema: "public");
            migrationBuilder.DropTable(name: "study_design", schema: "public");
        }
    }
}
